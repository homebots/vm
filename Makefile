...
build:
	docker run --rm -e VERBOSE -v$$(pwd):/home/espbuilder/project darlanalves/homebots-sdk make all
...
asm:
	docker run --rm -v$$(pwd)/:/home/espbuilder/project darlanalves/homebots-sdk:latest make disassemble
